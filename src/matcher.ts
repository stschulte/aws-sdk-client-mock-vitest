    ...
    : [
        ...
        ...calls.flatMap((call, index) => {
          ...
          return [
            ...
            '',
            expectedCall
              ? utils.diff(expectedCall, input, { omitAnnotationLines: true })
              : utils
                  .stringify(input)
                  .split('\n')
                  .map(line => `    ${line}`)
...
function toHaveReceivedCommandTimes<Input extends object, Output extends MetadataBearer>(
  ...
  return {
    message() {
      ...
      return formatCalls(utils, client, command, undefined, message);
    },
    pass,
  };
};
...
function toHaveReceivedCommandWith<Input extends object, Output extends MetadataBearer>(
  ...
  return {
    message() {
      ...
      return formatCalls(utils, client, command, input, message);
    },
    pass,
  };
};
...
function toHaveReceivedAnyCommand(
  ...
  return {
    message() {
      ...
      return formatCalls(utils, client, undefined, undefined, message);
    },
    pass,
  };
}
